  ...
  public static void main(String []arg){
   ...
   if(1-x/100==0.93)  //when the user enters 7
      ...
      System.out.println("The proportion remaining is "+0.40);
        ...
        float z=float (1-x/100);
        System.out.println("The proportion remaining is "+z);
 ...
 * Any number other than 14, 33, 60, 41, 14, or 7 is unacceptable.
 * Added else statement to take the rest of the numbers left out
 * of the program
 * 
 */
